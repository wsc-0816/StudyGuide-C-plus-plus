...
1.1 : terminal, You need this window to excute all programs not only c++ but also others
     How to install teminal:
     Open your launchpad 
     Open others(其它)
     Find "terminal"(终端)
...
2.1 How to excute a c++ file? 
    The c++ file ends with .cpp 
    There are two ways to run this file:
    2.1.1 : First, complie: Open your C++ file with sublime text, in the menu bar ,Click
    ...
    2.2.1: First complie: Open your terminal, transfer to your category where you saved c++  					   file.
    					  ...
    					  If you type somthing wrong, please use "cd  .." go back to the up level you were in.Or you can use "cd" to go back to root which is the begining of your treminal.
...
2.2 The difference between complie and run :
 Complie means that the computer will check your code to see if there is an bug or typo in your file.
